---
title: "GEM500: Landscape Metrics - Disturbance"
...
```{r}
fire.c8 <- calculate_lsm(landscape=fire, what = c("lsm_c_pland", "lsm_c_np", "lsm_c_area_mn"), progress = TRUE, neighbourhood = 8, directions = 8)

fire.l8 <- calculate_lsm(landscape=fire, what = c("lsm_l_ed", "lsm_l_contag"), progress=TRUE, neighbourhood = 8, directions = 8)
```
